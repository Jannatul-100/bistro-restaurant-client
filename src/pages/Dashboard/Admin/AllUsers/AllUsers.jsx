          ...
          <tbody>
            {users.map((user, index) => (
              <tr key={user._id}>
                ...
                <td>
                  {user.role === "admin" ? (
                    <span className="font-bold opacity-50">Admin</span>
                  ) : (
                    <button
                ...
                <td>
                  <button
                    ...
                    className="btn btn-sm lg:btn-md bg-red-600 text-white text-lg"
                  >
      ...
      <dialog id="user_modal" className="modal">
        <div className="modal-box max-w-4xl">
          ...
          {userDetails && (
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-6">
                <img
                  src={
                    userDetails.photo || "https://i.ibb.co/4pDNDk1/avatar.png"
                  }
                  alt="User"
              ...
              {userDetails.role === "admin" ? (
                <div className="alert alert-info">
                  <span>
                    This is an administrator account. Customer-related
                    information such as orders, payments, purchased items, and
                    reservations is not applicable.
                  </span>
                </div>
              ) : (
                <>
                  ...
                  {/* Recent Payments */}
                  <div>
                    <h2 className="font-bold text-xl mb-3">Recent Payments</h2>
                  ...
                  {/* Purchased Items */}
                  <div>
                    <h2 className="font-bold text-xl mb-3">Purchased Items</h2>
                  ...
                  {/* Reservations */}
                  <div>
                    <h2 className="font-bold text-xl mb-3">Reservations</h2>
          ...
          <div className="modal-action">
            <form method="dialog">
              <button className="btn btn-lg bg-orange-300 hover:bg-orange-400">
                Close
              </button>
            </form>
          </div>
